// trigger to play music in the background with sweetalert popup
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Specific targets configuration (12th June 2026, Age 17)
  const targetDay = 12;
  const targetMonthIndex = 5; // June is index 5
  ...
  // Re-calibrated calendar counting algorithm
